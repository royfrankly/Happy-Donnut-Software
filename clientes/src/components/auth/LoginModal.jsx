...
export default function LoginModal({ 
  ...
  setShowLogin,
  handleLogin,
  // 🛑 ACEPTAR LA NUEVA FUNCIÓN DE REGISTRO COMO PROP
  handleRegister 
}) {
      ...
      <div className="bg-white rounded-lg max-w-4xl w-full p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-orange-50 p-6 rounded-lg">
            ...
            {/* 🟢 Login Form: Usa handleLogin (Correcto) */}
          ...
          <div className={`${showLogin ? 'hidden' : 'block'} bg-white p-6 rounded-lg`}>
            ...
            {/* 🛑 CORRECCIÓN CLAVE: Ahora usa handleRegister (o la función pasada para registrar) */}
            <form onSubmit={handleRegister}>
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    type="text"
                    name="name" // Se añade atributo name para claridad
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    type="email"
                    name="email" // Se añade atributo name para claridad
                    value={loginForm.email}
                    onChange={(e) => setLoginForm({...loginForm, email: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 pl-10"
                    placeholder="tu@email.com"
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    type="password"
                    name="password" // Se añade atributo name para claridad
                    value={loginForm.password}
                    onChange={(e) => setLoginForm({...loginForm, password: e.target.value})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500 pl-10"
                    placeholder="••••••••"
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  <input
                    type="password"
                    name="confirmPassword" // Se añade atributo name para claridad
